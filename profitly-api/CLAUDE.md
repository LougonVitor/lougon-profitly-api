...
- **Backlog:** i18n das seções novas do finance; testes unitários do WalletService (padrão FinanceServiceTest); import CSV/B3 de negociações; rebalanceamento por classe; benchmark da carteira vs IBOV/CDI; agenda de proventos futuros
