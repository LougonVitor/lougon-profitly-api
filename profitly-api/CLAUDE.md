...
- **Comparação mensal (MoM)** na aba Histórico: calculada 100% no front a partir de `getHistory` (variação total R$/%, precisão real vs estimado, maiores variações por categoria) — sem endpoint novo
